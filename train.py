...
def main(args):
    ...
    def preprocess_data(examples):
        ...
        # encode them
        encoding = tokenizer(text1, padding="max_length", truncation=True, max_length=args.max_seq_len)
        # add labels
